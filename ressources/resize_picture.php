...
if(! defined('FILE_CACHE_TIME_BETWEEN_CLEANS')) define ('FILE_CACHE_TIME_BETWEEN_CLEANS', 0);   // How often the cache is cleaned 

if(! defined('FILE_CACHE_MAX_FILE_AGE') )   define ('FILE_CACHE_MAX_FILE_AGE', 0);              // How old does a file have to be to be deleted from the cache
...
if(! defined('MAX_WIDTH') )             define ('MAX_WIDTH', 140);                                 // Maximum image width
if(! defined('MAX_HEIGHT') )            define ('MAX_HEIGHT', 140);                                // Maximum image height
