...
$lang['fr']['click_remind'] 			=	"Cliquez ici pour vous en souvenir la prochaine fois";
$lang['fr']['what_zat'] 			=	"Qu'est ce que c'est ?";
$lang['fr']['popcorn_details'] 			=	"Comme tout le monde, vous ne savez jamais à quel épisode vous vous êtes arrêté(e) la dernière fois.<br/>Cliquez sur le petit lien précédent pour marquer cette vidéo comme \"vue\", elle sera légèrement soulignée dans la liste de Cakebox";
$lang['fr']['do_you_remember'] 			=	"vous avez déjà regardé cette vidéo, vous vous rappelez ?";
$lang['fr']['cancel_please'] 			=	"Non, marquez cette vidéo comme \"non-vue\".";
$lang['fr']['ok_mark'] 				=	"vous avez marqué cette vidéo comme \"vue\"";
$lang['fr']['ok_unmark'] 			=	"vous avez enlevé le marquage sur cette vidéo";
$lang['fr']['help_watching'] 			=	"Aidez-moi, je n'arrive pas à voir mes vidéos !";
...
$lang['en']['leave_edit_mode'] 			=	"Leave edit mode now";
$lang['en']['create_new_dir'] 			=	"Create new dir in...";
$lang['en']['move_dir'] 			=	"Move selected file(s) to...";
$lang['en']['delete_content'] 			=	"Delete selected files ?";
$lang['en']['create_new_dir'] 			=	"Create dir";
$lang['en']['move_dir'] 			=	"Let's move !";
$lang['en']['delete_content'] 			=	"Yes, delete content";
$lang['en']['show_all_files']			=	"Show all files";
$lang['en']['show_video_files']			=	"Show video files only";
...
$lang['en']['click_remind'] 			=	"Click here to remind you next time";
$lang['en']['what_zat'] 			=	"What's that ?";
$lang['en']['popcorn_details'] 			=	"Like everyone else, you never know what episode you stopped in your series.<br/>Click on the previous link to mark an episode and know quickly if you have already seen or not (it will be underlined in the main list)";
$lang['en']['do_you_remember'] 			=	"you've already seen this video, do you remember ?";
$lang['en']['cancel_please'] 			=	"Non, cancel please !";
$lang['en']['ok_mark'] 				=	"you have marked this video as \"seen\"";
$lang['en']['ok_unmark'] 			=	"you have unmarked this video";
$lang['en']['help_watching'] 			=	"Help, I can't watch my video !";
$lang['en']['watch_next'] 			=	"Watch the next episode";
